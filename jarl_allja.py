...
EXCHANGE_HINT = "Prefecture+PWR Abbiv."

name = "JARL_ALLJA"
cabrillo_name = "JARL_ALLJA"
...
def interface(self):
    ...
    self.other_label.setText("PrefNum")
    self.other_1.setAccessibleName("PrefNum")
    self.exch_label.setText("PWR")
    self.other_2.setAccessibleName("PWR")
...
def set_contact_vars(self):
    ...
    self.contact["Exchange1"] = self.other_1.text() + self.other_2.text().upper()
...
def adif(self):
    ...
    gen_adif(self, cabrillo_name, "JARL_ALLJA")
