...
EXCHANGE_HINT = "Prefecture+Appendix."

name = "JARL_KANHAM_CONTEST"
cabrillo_name = "JARL-KANHAM_CONTEST"
...
def interface(self):
    ...
    self.other_label.setText("Pref.")
    self.field3.setAccessibleName("Pref")
    self.exch_label.setText("Appendix.")
    self.field4.setAccessibleName("Ap")
...
def set_contact_vars(self):
    ...
    self.contact["Exchange1"] = self.other_1.text() + self.other_2.text()
...
def points(self):
    ...
    if call in EXPO_STATION:
        return 5 
    appendix = self.contact.get("Exchange1","")
    if appendix in FLAG_INDEX:
        return 5
...
def adif(self):
    ...
    gen_adif(self, cabrillo_name, "JARL_KANHAM_CONTEST")
